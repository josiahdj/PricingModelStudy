...
type ImplementationDrivers = {TeamMembers: int<Person>; TripsPerMonth: int<Trip/Month>; TravelDrivers: TransportDrivers; LodgingDrivers: LodgingDrivers}
...
let implementationCost inputs =
    ...
    {TransportCost = transport; LodgingCost = lodging; EquipmentCost = equipment; CrewCost = crew; OtherCost = other} // put in a record?
